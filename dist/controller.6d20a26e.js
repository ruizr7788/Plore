...
},{}],"views/serviceSectionView.js":[function(require,module,exports) {
"use strict";
...
var _parent_element = /*#__PURE__*/new WeakMap();

var ServiceSection = /*#__PURE__*/function () {
  function ServiceSection() {
    _classCallCheck(this, ServiceSection);

    _classPrivateFieldInitSpec(this, _parent_element, {
      writable: true,
  ...
  _createClass(ServiceSection, [{
    ...
    value: function addHandlerRender(handler) {
      ...
      observer.observe(_classPrivateFieldGet(this, _parent_element));
    }
  }]);
...
var _default = new ServiceSection();
...
var _navbarEl = /*#__PURE__*/new WeakMap();
...
var NavbarView = /*#__PURE__*/function () {
  function NavbarView() {
    ...
    _classPrivateFieldInitSpec(this, _parentEl, {
      writable: true,
      value: document.getElementById("home")
    });

    _classPrivateFieldInitSpec(this, _navbarEl, {
      writable: true,
      value: document.getElementById("navbar")
    });
  }
  ...
  _createClass(NavbarView, [{
    key: "addHandlerRender",
    value: function addHandlerRender(handler) {
      var lanPageObserver = new IntersectionObserver(handler, {
        root: null,
        threshold: 0
      });
      lanPageObserver.observe(_classPrivateFieldGet(this, _parentEl));
    }
  }]);
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    key: "renderSpinner",
    value: function renderSpinner(parentEl) {
      var spinnerMarkup = this._generateSpinnerMarkup();

      parentEl.insertAdjacentHTML("beforeend", spinnerMarkup);
    }
  }, {
    key: "_generateSpinnerMarkup",
    value: function _generateSpinnerMarkup() {
...
},{}],"views/weatherBarView.js":[function(require,module,exports) {
"use strict";
...
var _weatherInput = /*#__PURE__*/new WeakMap();

var WeatherView = /*#__PURE__*/function (_View) {
  _inherits(WeatherView, _View);

  var _super = _createSuper(WeatherView);
  ...
  function WeatherView() {
    ...
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _parentElement, {
      writable: true,
      value: document.querySelector(".weather-strip")
    });

    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _weatherInput, {
      writable: true,
      value: document.getElementById("weather_search")
    });
  ...
  _createClass(WeatherView, [{
    ...
    value: function addHandlerRender(handler) {
      ...
      var form = document.querySelector(".form--weather-search");
      form.addEventListener("submit", function (e) {
        e.preventDefault();

        _this2.renderSpinner(_classPrivateFieldGet(_this2, _parentElement)); //   input


        var query = _classPrivateFieldGet(_this2, _weatherInput).value;
    ...
    value: function renderWeather(data) {
      ...
      _classPrivateFieldGet(this, _parentElement).insertAdjacentHTML("beforeend", "<p class=\"location-label\">Showing results for ".concat(_classPrivateFieldGet(this, _data).location.name, ", ").concat(_classPrivateFieldGet(this, _data).location.region, "</p>"));
    ...
    value: function generateMarkup() {
      var data = _classPrivateFieldGet(this, _data).weather;

      var html = data.map(function (day) {
        return "\n        <div class=\"weathercard\">\n              <h2 id=\"".concat(day.weekday, "\" class=\"weekday\">").concat(day.weekday, "</h2>\n            <div class=\"weather-info\">\n                <h3 id=\"deg\">").concat(day.day.avgtemp_f, "</h3>\n                <div class=\"img_des\">\n                  <img id=\"img\" src=\"").concat(day.day.condition.icon, "\" alt=\"...\" />\n                  <p id=\"des\">").concat(day.day.condition.text, "</p>\n                </div>\n\n                <p class=\"weather-range\">\n                  <span id=\"high_temp\">H: ").concat(day.day.maxtemp_f, "</span><br /><span id=\"low_temp\"\n                    >L: ").concat(day.day.mintemp_f, "</span\n                  >\n                </p>\n            </div>\n        </div>\n        \n        ");
      }).join("");
      return html;
    }
  }, {
    ...
    value: function _clear() {
      ...
      _classPrivateFieldGet(this, _weatherInput).blur();
    }
  }]);
...
var sectionFadeIn = function sectionFadeIn(entry, observer) {
...
exports.sectionFadeIn = sectionFadeIn;

var stickyNavbar = function stickyNavbar(entries, observer) {
  var _entries = _slicedToArray(entries, 1),
      entry = _entries[0];

  if (entry.isIntersecting === false) navbar.classList.add("fixed");else navbar.classList.remove("fixed");
}; // ---------- Weather ----------


exports.stickyNavbar = stickyNavbar;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            state.weather = []; // get weather using the search query

            _context.next = 4;
            return getJSON("http://api.weatherapi.com/v1/forecast.json?key=29e0186ae9ac4bc18c444525220402&q=".concat(query, "&days=7"));
          ...
          case 4:
            ...
            (_state$weather = state.weather).push.apply(_state$weather, _toConsumableArray(data.forecast.forecastday));

            state.weather.forEach(function (day) {
...
var _serviceSectionView = _interopRequireDefault(require("./views/serviceSectionView"));
...
var sectionController = function sectionController(entry, observer) {
  // once section container is 10% in view render section
  model.sectionFadeIn(entry, observer);
};

var navbarController = function navbarController(entry, observer) {
...
var weatherController = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return model.setState(query);

          case 3:
            // render data
            _weatherBarView.default.renderWeather(model.state);
          ...
          case 6:
            ...
            _weatherBarView.default.renderError();
  ...
  return function weatherController(_x) {
    return _ref.apply(this, arguments);
  };
}();

var init = function init() {
  _serviceSectionView.default.addHandlerRender(sectionController);

  _navbarView.default.addHandlerRender(navbarController);

  _weatherBarView.default.addHandlerRender(weatherController);
};
